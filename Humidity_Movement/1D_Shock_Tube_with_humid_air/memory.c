...
void Allocate_memory(float **array1, float **array2, float **array3, float **array4, float **array5, float **array6,
	...
	*array18 = (float*)malloc((N_CELLS+2) * sizeof(float));
	*array19 = (float*)malloc((N_CELLS+2) * sizeof(float));
	*array20 = (float*)malloc((N_CELLS+2) * sizeof(float));
