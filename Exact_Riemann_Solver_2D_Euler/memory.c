...
void Allocate_memory(float **array1, float **array2, float **array3, float **array4, float **array5, float **array6, float **array7, float **array8, float **array9, int N_CELLS){
	...
	*array7 = (float*)malloc((N_CELLS) * 6 * sizeof(float)); // interface_p have 6 output
	*array8 = (float*)malloc((N_CELLS) * 5 * sizeof(float)); // flux_X have 5 ouuput
	*array9 = (float*)malloc((N_CELLS) * 5 * sizeof(float)); // flux_Y have 5 ouuput
